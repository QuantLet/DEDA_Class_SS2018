...
worldcup = open('C:/Users/VWRZTS0/Desktop/DEDA/DEDA/datasets/WorldCup2018_adapted_semifinals.csv','r')
...
results = pd.read_csv('C:/Users/VWRZTS0/Desktop/DEDA/DEDA/datasets/results_adapted_semifinals.csv')
...
#Filter out games with World Cup Teams
participants=[]
for i in range(len(results['home_team'])):
...
#Data cleaning: Replace team names so that dataframes are compatible
...
worldcup_16=worldcup.iloc[52:56,:]
