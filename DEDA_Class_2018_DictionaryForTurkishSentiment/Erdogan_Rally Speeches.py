...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 22 21:57:56 2018
...
url = "http://www.akparti.org.tr/site/haberler/cumhurbaskani-erdogan-ankara-mitingine-katidi/101539#1"

rtemanif = requests.get(url)  
html = rtemanif.text  
soup = BeautifulSoup(html, 'html.parser')
print(soup.find('div', {"class" : "detail-text"}).text)

text = str(soup.find('div', {"class" : "detail-text"}).text)
...
#plt.title("Erdogan Speech Most Frequent Words")
#plt.tight_layout()
#plt.savefig("2_RTE FrequentWords.png", transparent = True, dpi=1000)
...
plt.title("Erdogan Speech Most Frequent Words 12")
plt.tight_layout()
plt.savefig("12_RTE FrequentWordsEN.png", transparent = True, dpi=1000)
...
plt.title("Erdogan Election Speech - Word Cloud 12")
plt.savefig("12 RTE - Word Cloud.png", transparent=True, dpi=1000)
plt.show()
